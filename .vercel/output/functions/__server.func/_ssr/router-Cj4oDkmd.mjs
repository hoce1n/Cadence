...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Cj4oDkmd.js
var router_Cj4oDkmd_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-BcR2Jcd_.css";
var APP_NAME = "Cadence";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Track daily habits, keep streaks, and see your month at a glance."
			},
			{
				name: "theme-color",
				content: "#f3eee4"
...
var $$splitComponentImporter = () => import("./routes-EPLF3mmG.mjs");
...
//#endregion
export { getRouter, router_Cj4oDkmd_exports as t };
